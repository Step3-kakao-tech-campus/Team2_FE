...
const AlbumCreationPage: React.FC = () => {
  ...
  return (
      ...
      <div className="group_photo_input">
        {uploadedPhoto ? (
          ...
          <button className="group_photo_button" 
            onClick={openModal}>+ <tr/>사진 업로드</button>
        )}
      </div>
      <Modal
      isOpen={modalIsOpen}
    ...
    >
      ...
      <div className="group_photo_modal_description">그룹만의 대표 사진을 설정<tr/>할 수 있어요 !</div>
      ...
      <div className="group_invitees">
        <div className="group_invitees_title">그룹원<tr/>초대</div>
